...
case class CreateTeam(ownerName: String, teamName: String, teamNumber: Option[Int] = None) derives ConfiguredCodec

case class UpdateTeam(ownerName: Option[String], teamName: Option[String]) derives ConfiguredCodec
